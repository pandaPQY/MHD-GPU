...
{
block_u1234[localIdY][localIdX][localIdZ]=t12_u1234[a3D_FinC((box_nx),(box_ny),(box_nz),i_index,j_index,k_index)];
}
...
temp_thread_u1234.y=temp_thread_u1234.z;
temp_thread_u1234.z=temp_thread_u_float;
//	put u
...
if ((i_index<box_nx)&&(j_index<box_ny)&&(k_index<box_nz))
{
t12_u_update1234[a3D_FinC((box_ny),(box_nx),(box_nz),j_index,i_index,k_index)]=block_u1234[localIdX][localIdY][localIdZ];
}
}
