...
int
setupCL_advectbyzxA1_ProgramKernel()
{
    ...
    file[3]=fopen("advectbyzxA1_Kernels.cl","rb");
    int i;
...
int
setupCL_advectbyzxA2_ProgramKernel()
{
    cl_int status_in_setupCL = CL_SUCCESS;
//
    int number_of_file = 4;
    ...
    file[1]=fopen("parameter.h","rb");
    file[2]=fopen("array_definition.h","rb");
    file[3]=fopen("advectbyzxA2_Kernels.cl","rb");
    int i;
    for (i=0; i<number_of_file; i++)
    {
        if (file[i] == NULL)
...
int
setupCL_advectbyzxB1_ProgramKernel()
{
    cl_int status_in_setupCL = CL_SUCCESS;
//
    int number_of_file = 4;
    ...
    file[1]=fopen("parameter.h","rb");
    file[2]=fopen("array_definition.h","rb");
    file[3]=fopen("advectbyzxB1_Kernels.cl","rb");
    int i;
    for (i=0; i<number_of_file; i++)
    {
        if (file[i] == NULL)
...
int
setupCL_advectbyzxB2_ProgramKernel()
{
    cl_int status_in_setupCL = CL_SUCCESS;
//
    int number_of_file = 4;
    ...
    file[1]=fopen("parameter.h","rb");
    file[2]=fopen("array_definition.h","rb");
    file[3]=fopen("advectbyzxB2_Kernels.cl","rb");
    int i;
    for (i=0; i<number_of_file; i++)
    {
        if (file[i] == NULL)
...
int
setupCL_advectbyzxA1_ArgumentKernel()
{
    cl_int status_in_setupCL = CL_SUCCESS;
...
int
setupCL_advectbyzxA2_ArgumentKernel()
{
    cl_int status_in_setupCL = CL_SUCCESS;
//	u
    status_in_setupCL = clSetKernelArg(
...
int
setupCL_advectbyzxB1_ArgumentKernel()
{
    cl_int status_in_setupCL = CL_SUCCESS;
//	u
    status_in_setupCL = clSetKernelArg(
...
int
setupCL_advectbyzxB2_ArgumentKernel()
{
    cl_int status_in_setupCL = CL_SUCCESS;
//	u
    status_in_setupCL = clSetKernelArg(
