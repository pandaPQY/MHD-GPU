...
{
block_u5[localIdZ][localIdY][localIdX]=t13_u5[a3D_FinC((box_nx),(box_ny),(box_nz),i_index,j_index,k_index)];
block_b[localIdZ][localIdY][localIdX]=t13_b[a3D_FinC((box_nx),(box_ny),(box_nz),i_index,j_index,k_index)];
}
...
//      transpose b
temp_thread_b_float=temp_thread_b.z;
temp_thread_b.z=temp_thread_b.x;
...
if ((i_index<box_nx)&&(j_index<box_ny)&&(k_index<box_nz))
{
t13_u_update5[a3D_FinC((box_ny),(box_nx),(box_nz),k_index,j_index,i_index)]=block_u5[localIdX][localIdY][localIdZ];
t13_b_update[a3D_FinC((box_ny),(box_nx),(box_nz),k_index,j_index,i_index)]=block_b[localIdX][localIdY][localIdZ];
}
}
