...
printf("t= %e,     %e,     %i,     %e,     %e\n",ctx.dt,t,iter,ctx.u[matrix4D(5,ctx.nx,ctx.ny,ctx.nz,(5-1),(1-1),(3-1),(1-1))],ctx.u[matrix4D(5,ctx.nx,ctx.ny,ctx.nz,(1-1),(2-1),(1-1),(1-1))]);
...
//   } while (iter<1);
  ...
  result_u1=fopen("result_u1.dat","w+");
  result_b1=fopen("result_b1.dat","w+");
//fwrite(&ctx.u,sizeof(float),5*ctx.nx*ctx.ny*ctx.nz,result_u1);
//fwrite(&ctx.b,sizeof(float),3*ctx.nx*ctx.ny*ctx.nz,result_b1);
        for (i=0;i<(ctx.nz);i++)
        {
                for (j=0;j<(ctx.ny);j++)
                {
...
//                                for (ii=0;ii<5;ii++)
//                                {
//                                         fwrite(&ctx.u[matrix4D(5,(ctx.nx),(ctx.ny),(ctx.nz),ii,i,j,k)],sizeof(float),1,result_u1);
//                                         if (ii<3) { 
//                                            fwrite(&ctx.b[matrix4D(5,(ctx.nx),(ctx.ny),(ctx.nz),ii,i,j,k)],sizeof(float),1,result_b1);
//                                            }
//                                 }
                                  fwrite(&ctx.u[matrix4D(5,(ctx.nx),(ctx.ny),(ctx.nz),(1-1),i,j,k)],sizeof(float),1,result_u1);
                                  fwrite(&ctx.u[matrix4D(5,(ctx.nx),(ctx.ny),(ctx.nz),(2-1),i,j,k)],sizeof(float),1,result_u1);
                                  fwrite(&ctx.u[matrix4D(5,(ctx.nx),(ctx.ny),(ctx.nz),(3-1),i,j,k)],sizeof(float),1,result_u1);
                                  fwrite(&ctx.u[matrix4D(5,(ctx.nx),(ctx.ny),(ctx.nz),(4-1),i,j,k)],sizeof(float),1,result_u1);
                                  fwrite(&ctx.u[matrix4D(5,(ctx.nx),(ctx.ny),(ctx.nz),(5-1),i,j,k)],sizeof(float),1,result_u1);
                                  fwrite(&ctx.b[matrix4D(3,(ctx.nx),(ctx.ny),(ctx.nz),(1-1),i,j,k)],sizeof(float),1,result_b1);
                                  fwrite(&ctx.b[matrix4D(3,(ctx.nx),(ctx.ny),(ctx.nz),(2-1),i,j,k)],sizeof(float),1,result_b1);
                                  fwrite(&ctx.b[matrix4D(3,(ctx.nx),(ctx.ny),(ctx.nz),(3-1),i,j,k)],sizeof(float),1,result_b1);
//                                fprintf(result_u1,"%f\n",ctx.u[matrix4D(5,(ctx.nx),(ctx.ny),(ctx.nz),(1-1),i,j,k)]);
//                                fprintf(result_u1,"%f\n",ctx.u[matrix4D(5,(ctx.nx),(ctx.ny),(ctx.nz),(2-1),i,j,k)]);
//                                fprintf(result_u1,"%f\n",ctx.u[matrix4D(5,(ctx.nx),(ctx.ny),(ctx.nz),(3-1),i,j,k)]);
//                                fprintf(result_u1,"%f\n",ctx.u[matrix4D(5,(ctx.nx),(ctx.ny),(ctx.nz),(4-1),i,j,k)]);
//                                fprintf(result_u1,"%f\n",ctx.u[matrix4D(5,(ctx.nx),(ctx.ny),(ctx.nz),(5-1),i,j,k)]);
//                                fprintf(result_b1,"%f\n",ctx.u[matrix4D(5,(ctx.nx),(ctx.ny),(ctx.nz),(1-1),i,j,k)]);
//                                fprintf(result_b1,"%f\n",ctx.u[matrix4D(5,(ctx.nx),(ctx.ny),(ctx.nz),(2-1),i,j,k)]);
//                                fprintf(result_b1,"%f\n",ctx.u[matrix4D(5,(ctx.nx),(ctx.ny),(ctx.nz),(3-1),i,j,k)]);
                        }
