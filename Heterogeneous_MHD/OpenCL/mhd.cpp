...
for (ii=0;ii<3;ii++)
{
                        ...
                        {
                        infile.read((char*)&initV_u[a4D_FinC(5,(*initV_nx),(*initV_ny),(*initV_nz),0,i,j,k)],sizeof(float));
                        infile.read((char*)&initV_u[a4D_FinC(5,(*initV_nx),(*initV_ny),(*initV_nz),1,i,j,k)],sizeof(float));
                        infile.read((char*)&initV_u[a4D_FinC(5,(*initV_nx),(*initV_ny),(*initV_nz),2,i,j,k)],sizeof(float));
                        infile.read((char*)&initV_u[a4D_FinC(5,(*initV_nx),(*initV_ny),(*initV_nz),3,i,j,k)],sizeof(float));
                        infile.read((char*)&initV_u[a4D_FinC(5,(*initV_nx),(*initV_ny),(*initV_nz),4,i,j,k)],sizeof(float));
                        infile.read((char*)&initV_b[a4D_FinC(5,(*initV_nx),(*initV_ny),(*initV_nz),0,i,j,k)],sizeof(float));
                        infile.read((char*)&initV_b[a4D_FinC(5,(*initV_nx),(*initV_ny),(*initV_nz),1,i,j,k)],sizeof(float));
                        infile.read((char*)&initV_b[a4D_FinC(5,(*initV_nx),(*initV_ny),(*initV_nz),2,i,j,k)],sizeof(float));     
...
//                        fscanf(initV_File,"%f",&initV_b[a4D_FinC(3,(*initV_nx),(*initV_ny),(*initV_nz),2,i,j,k)]);
                        printf("u,b= %f, %f,\n",initV_u[a4D_FinC(5,(*initV_nx),(*initV_ny),(*initV_nz),2,i,j,k)],initV_b[a4D_FinC(3,(*initV_nx),(*initV_ny),(*initV_nz),1,i,j,k)]);
                        }
...
printf("end in init\n");
printf("u,b= %f,     %f\n",initV_u[a4D_FinC(5,(*initV_nx),(*initV_ny),(*initV_nz),2,0,0,0)],initV_b[a4D_FinC(3,(*initV_nx),(*initV_ny),(*initV_nz),1,0,0,0)]);
}
...
//
	...
	return MHD_FAILURE;
//
printf("u,b= %f,     %f\n",ctx_host.u[a4D_FinC(5,ctx_host.nx,ctx_host.ny,ctx_host.nz,2,0,0,0)],ctx_host.b[a4D_FinC(3,ctx_host.nx,ctx_host.ny,ctx_host.nz,1,0,0,0)]);
